...
sub setup() returns Int is native('support') { ... }
...
sub encode_v8(Buf $data) returns Buf is export is native('support') { ... }
sub decode_v8(Buf $data) returns Str is export is native('support') { ... }
