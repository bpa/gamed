...
import gamed.client.SpeedRisk.ClassicBoard;
import gamed.client.SpeedRisk.UltimateBoard;
...
public class Login extends JApplet implements GameListing, Server, Runnable
{
    ...
    /**
     * I'm just going to disconnect the socket and send you to the connect screen if the poll fails
     * (IOException of some kind)<br/>
     * Options:
     * <ul>
    ...
    /**
     * This method is called from within the init() method to initialize the form. WARNING: Do NOT modify this
    ...
    private void initComponents()
    {
        ...
        jPanel10.add(statusLabel, java.awt.BorderLayout.CENTER);
    ...
    /**
     * @todo There is a race condition here. If you try and join 2 game types at
     * once, you will be added to the first and get an error for the second you
     * would then be in the "wrong" game.
